...
pos_marker = line.find(marker) #find the marker
l_marker = len(marker) #length of the marker
replaced = line[:pos_marker] + replacement + line[(pos_marker + l_marker):] #remove marker and add replacement
